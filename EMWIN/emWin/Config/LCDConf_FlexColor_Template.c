...
void LCD_X_Config(void) {
	...
	if((lcddev.id == 0X5510)||(lcddev.id == 0X1963)||(lcddev.id==0X7084)||(lcddev.id==0X4342)||(lcddev.id==0X7016)||(lcddev.id==0X1018)) //电容屏
	{
	...
	}else if(lcddev.id == 0X5310||lcddev.id == 0X6804) //0X5510 0X6804为3.5寸 320x480
	{
		...
		}else //横屏
		{
			...
			GUI_TOUCH_Calibrate(GUI_COORD_Y,0,320,3931,226);
			GUI_TOUCH_Calibrate(GUI_COORD_X,0,480,3812,196); 	
		}
	}
